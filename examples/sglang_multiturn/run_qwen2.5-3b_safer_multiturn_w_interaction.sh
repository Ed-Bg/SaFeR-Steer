...
# ======== wandb settings ========
# Please set your own WANDB_API_KEY via: export WANDB_API_KEY="your_key" or wandb login
export WANDB_API_KEY="${WANDB_API_KEY:-}"
export WANDB_ENTITY="${WANDB_ENTITY:-your_wandb_entity}"
export WANDB_MODE="${WANDB_MODE:-online}"                  # online/offline/disabled
export WANDB_NOTES="SafeDy multi-turn RL training"
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=${MODEL_PATH:-"<YOUR_MODEL_PATH>"} \
    ...
    trainer.project_name='safedy_rl' \
    trainer.experiment_name='safedy_multiturn_training' \
